...
int main(){
    ...
    c1.setData(2,3);
    c2.setData(4,6);
    //c3=c1+c2;        // when compiler reach to this line, it tries to find out the right defination of '+' operator 
                     //Because compiler knows how to add the primitve type of data but it is complex type of data, Hence it throws error.
